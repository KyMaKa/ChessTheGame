...
public abstract class Piece {
    ...
    public Piece(String piece_name, ChessBoard board, Player player){
        ...
        this.x_coordinate = -1;                   // init coordinate to -1, which means the piece is not put to game board yet
        this.y_coordinate = -1;
    ...
    /**
     * Set the coordinate of piece on game board
    ...
    /**
     * Piece removes itself from game board
     */
