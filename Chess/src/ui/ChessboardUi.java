...
public class ChessboardUi extends JPanel {
    public ChessBoard board; // chessboard that we are using
    ...
    public double clicked_x_coord = -1;
    public double clicked_y_coord = -1;

    public ChessboardUi(ChessBoard board, GameController game_controller, int tile_size, int board_width, int board_height){
